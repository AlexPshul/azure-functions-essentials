 ...
 */
export function startMcpChain<TArgs>(): FunctionChain<unknown, 'json', BasicChainData & { parsedData: TArgs }, BasicChainData>;
/**
 ...
 */
export function startMcpChain<TArgs>(zodSchema: ZodType<TArgs>): FunctionChain<unknown, 'json', BasicChainData & { parsedData: TArgs }, BasicChainData>;
